...
export const ShipIcon: React.FC<IconProps> = ({ size = 20, ...props }) => (
  ...
  >
    <path d="M2 21h20" />
    <path d="M19.3 14.8C21.1 13.5 22 11.7 22 9.5c0-3.6-4.5-6.5-10-6.5S2 5.9 2 9.5c0 2.2.9 4 2.7 5.3" />
    <path d="M4 14.8V17a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2.2" />
    <path d="M12 3v6.5" />
    <path d="M8 4.5v3.5" />
    <path d="M16 4.5v3.5" />
  </svg>
...
// Dashboard icon (3 layout panels)
...
// Anchor icon for Fleet
export const FleetIcon: React.FC<IconProps> = ({ size = 20, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
// Monitor screen TV Mode icon
export const TvIcon: React.FC<IconProps> = ({ size = 20, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
// Mail envelope logs icon
export const LogsIcon: React.FC<IconProps> = ({ size = 20, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
// Door right arrow exit logout icon
...
// Cloud download / tray excel import icon
export const ImportIcon: React.FC<IconProps> = ({ size = 20, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
// Critical urgent error alarm siren icon
...
export const AttachmentIcon: React.FC<IconProps> = ({ size = 20, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
// Eye Off icon (visibility slashed)
